        ...
        return (
            <div className="App">
                ...
                <Switch>
                    <Route
                        path="/inbox"
                        component={() => <MailBoxPage type={PAGE_TYPE.INBOX} sendMail={this.sendMail} />}
                    />
                    <Route
                        path="/outbox"
                        component={() => <MailBoxPage type={PAGE_TYPE.OUTBOX} sendMail={this.sendMail} />}
                    />
                    <Route
                        path="/draft"
                        component={() => <MailBoxPage type={PAGE_TYPE.DRAFT} sendMail={this.sendMail} />}
                    />
