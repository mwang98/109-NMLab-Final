        ...
        <div className="wrapper">
          <div style={{'text-align':'center' }}>
            <div style={{display:'inline-block', 'vertical-align': "top"}} className="buttons">
              <div style={{cursor:"pointer"}} onClick={() => this.handleClick('prev')} className="page-button">&#8592;</div>
            </div>
            ...
            <div style={{display:'inline-block', 'vertical-align': "top"}} className="buttons">
              <div style={{cursor:"pointer"}} onClick={() => this.handleClick('next')} className="page-button">&#8594;</div>
            </div>
          </div>
        </div>
      )
